...
\footnote{Conhecido pela sigla em inglês \acro{wysiwyg}\index{wysiwyg@\acro{wysiwyg}},
  \emph{what you see is what you get}.} (ao menos deveria ser), ao usar
\LaTeX\ \emph{o que você vê é o que você quis dizer}%
\footnote{Do inglês: \emph{what you see is what you mean} (\acro{wyhiwym})\index{wysiwym@\acro{wysiwym}}.}.
