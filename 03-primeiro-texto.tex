...
ao \LaTeX. Pacotes tem muitas vezes a extensão \extensao{sty}, embora
...
delimitar o fim do argumento de \verb'\verb'. A esse caractere se
segue o texto a ser ``verbatimizado,'' que é todo o texto até a
próxima ocorrência do delimitador. Exemplo: \verb'\verb!\LaTeX!''
resulta em `\verb!\LaTeX!', mas `\verb'\LaTeX'' resulta `\LaTeX'.
