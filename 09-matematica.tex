...
\input{exemplos/09-sub-e-superscripts-math-01}
\end{minipage}
\end{tabular}
\smallskip\hrule
\end{center}
...
\end{minipage} &
\begin{minipage}{.535\textwidth}\setlength{\parindent}{1pc}
\input{exemplos/09-sub-e-superscripts-math-02}
\end{minipage}
\end{tabular}
\smallskip\hrule
\end{center}
...
\end{minipage} &
\begin{minipage}{.535\textwidth}\setlength{\parindent}{1pc}
\input{exemplos/09-sub-e-superscripts-math-03}
\end{minipage}
\end{tabular}
\smallskip\hrule
\end{center}
...
\end{minipage} &
\begin{minipage}{.535\textwidth}\setlength{\parindent}{1pc}
\input{exemplos/09-sub-e-superscripts-math-04}
\end{minipage}
\end{tabular}
\smallskip\hrule
\end{center}
...
afastar elementos do texto horizontalmente\footnote{Comumente dizemos
  ...
  e~\macroCall{thinspace} produz um espaço fino.} (mais sobre espaços
...
\end{minipage} &
\begin{minipage}{.535\textwidth}\setlength{\parindent}{1pc}
\input{exemplos/09-sub-e-superscripts-math-05}
\end{minipage}
\end{tabular}
\smallskip\hrule
\end{center}
